...
vectors['c'] = np.array([+sq2,-sq2, sq2])
vectors['d'] = np.array([-sq2,-sq2, sq2])

scales = {'a':0.5, 'b':0.5, 'c':0.5, 'd':0.5}
...
linden = L_system('A',{'A':'[AaA][bA][cA][dA]','B':'[BaA][cC]','C':'[aA]'})

result = linden.get_iteration(n=6)
print(result)
